"""BT_RX Sensitivity (BER, 1DH5 only) -- ATE counterpart to
make_bt_rx_sensitivity_ber_revision1.py. Must run AFTER that script
(imports its build_jobs()/title_for()/audit helpers directly; the 1DH5-only
packet filter lives there, not duplicated here).
...
import make_bt_rx_sensitivity_ber_revision1 as bench_mod
