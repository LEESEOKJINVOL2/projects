...
def read_all(bt_tx_dir: Path):
    """Return (duts, data) where data[key][dut][freq] = evm_aver_aver-%."""
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out-dir", type=Path, default=PATHS.result_xlsx_dir / "evm")
    p.add_argument("--png-dir", type=Path, default=PATHS.result_png_dir / "evm")
